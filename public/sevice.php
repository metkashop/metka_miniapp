<?php
// Читаем учётные данные из переменных окружения
define('ACCOUNT', getenv('CDEK_ACCOUNT') ?: '');
define('SECURE', getenv('CDEK_SECURE') ?: '');

// Если переменные не заданы – ошибка
if (!ACCOUNT || !SECURE) {
    http_response_code(500);
    die('CDEK credentials not configured');
}

$service = new service(ACCOUNT, SECURE);
