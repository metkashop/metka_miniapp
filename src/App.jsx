...
function ProductDetail({ product, onAdd, favorites, toggleFavorite }) {
  ...
  return (
    <div style={{ overflowY: 'auto', paddingBottom: '24px', width: '100%' }}>
      ...
      <div style={{ position: 'relative', width: '100%', aspectRatio: '3/4', overflow: 'hidden', background: '#2a2a2a', cursor: 'zoom-in' }} onClick={() => setLightbox(`${API}/${images[currentImg]}`)} onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
